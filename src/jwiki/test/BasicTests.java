...
/**
 * Basic tests (non-admin) for jwiki's Wiki.java.  As a caveat, this simply serves as a crude sanity check for me when I modify the jwiki core, 
...
public class BasicTests
{
	...
	public void testPrefixIndex()
	{
		...
		List<String> expected = Arrays.asList("User:Fastily/Sandbox/Page/1", "User:Fastily/Sandbox/Page/2", "User:Fastily/Sandbox/Page/3");
	...
	public void testAllPages2()
	{
		...
		List<String> expected = Arrays.asList("User:Fastily/Sandbox/Redirect1", "User:Fastily/Sandbox/Redirect2");
	...
	public void testFileUsage()
	{
		...
		List<String> expected = Arrays.asList("User:Fastily/Sandbox/ImageLinks", "User:Fastily/Sandbox/Page");
	...
	public void testGetCategoriesOnPage()
	{
		...
		List<String> expected = Arrays.asList("Category:Fastily Test", "Category:Fastily Test2");
	...
	public void testGetCategoryMembers1()
	{
		...
		List<String> expected = Arrays.asList("User:Fastily/Sandbox/Page/2", "File:FastilyTest.png");
	...
	public void testGetCategoryMembers3()
	{
		...
		List<String> possible = Arrays.asList("User:Fastily/Sandbox/Page/1", "User:Fastily/Sandbox/Page/2", "User:Fastily/Sandbox/Page/3");
	...
	public void testGetImagesOnPage()
	{
		...
		List<String> expected = Arrays.asList("File:FastilyTest.svg", "File:FastilyTest.png");
	...
	public void testGetLinksOnPage1()
	{
		...
		List<String> expected = Arrays.asList("User:Fastily/Sandbox/Page/1", "User:Fastily/Sandbox/Page/2", "User:Fastily/Sandbox/Page/3", "User:Fastily/Sandbox/Page/4");
